...
class ProfilePage(BasePage):
    ...
    @allure.step('Открыть страницу пользователя')
    ...
    @allure.step('Показать архивные категории')
    ...
    @allure.step('Получить текст ошибки по полю категория')
    ...
    @allure.step('Сделать категорию архивной')
